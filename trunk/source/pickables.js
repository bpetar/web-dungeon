...
// id, name, model, x, z
pickables_array = [[1,"dagger","dagger.js", 2,5], [2,"holy symbol","models/tost.js", 6,4]];
...
function load_pickables () {
	...
	for(var i=0; i<pickables_array.length; i++) {
		...
		picki.position.x = pickables_array[i][3]*SQUARE_SIZE;
		picki.position.z = pickables_array[i][4]*SQUARE_SIZE;
